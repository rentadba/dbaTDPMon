			...
			BEGIN TRY
				...
				IF @optionXPValue=1 OR @SQLMajorVersion=8
					begin
						...
						--SET @queryToRun = @queryToRun + N'DECLARE @cmdQuery [varchar](102); SET @cmdQuery=''net config workstation | findstr /C:"Full Computer name"''; EXEC xp_cmdshell @cmdQuery;'
						...
						UPDATE #xpCMDShellOutput SET [output]=LTRIM(RTRIM(REPLACE(REPLACE([output], ' ', ''), CHAR(13), '')))
